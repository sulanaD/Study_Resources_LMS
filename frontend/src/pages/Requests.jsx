                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 mt-3 text-xs text-gray-500">
                      {request.category_name && <span>Category: {request.category_name}</span>}
                  ...
                  {isOwner && !isEditing && (
                    <div className="flex gap-1 ml-4">
                      <button onClick={() => handleEdit(request)} className="p-1.5 text-gray-400 hover:text-primary-600 rounded">
                        <Edit2 className="h-4 w-4" />
                      </button>
                      <button onClick={() => handleDelete(request.id)} className="p-1.5 text-gray-400 hover:text-red-600 rounded">
                  ...
                  {isEditing && (
                    <div className="flex gap-1 ml-4">
                      <button onClick={() => handleSaveEdit(request.id)} className="p-1.5 text-green-600 hover:bg-green-50 rounded">

      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {tutors.map((tutor) => {
            ...
            return (
              <div key={tutor.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {isOwner && !isEditing && (
                      <div className="flex gap-1">
                        <button onClick={() => handleEdit(tutor)} className="p-1 text-gray-400 hover:text-primary-600 rounded">
                          <Edit2 className="h-4 w-4" />
                        </button>
                        <button onClick={() => handleDelete(tutor.id)} className="p-1 text-gray-400 hover:text-red-600 rounded">
                    ...
                    {isEditing && (
                      <div className="flex gap-1">
                        <button onClick={() => handleSaveEdit(tutor.id)} className="p-1 text-green-600 hover:bg-green-50 rounded">
